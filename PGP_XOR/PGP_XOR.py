...
class PgpXor(ACrypt):
    ...
    def _encrypt(self, message: str) -> str:
        ...
        xor : Xor = Xor("57696e74657220697320636f6d696e67")
    ...
    def _decrypt(self, message: str) -> str:
        ...
        xor : Xor = Xor(rsa._decrypt("97f2af4c1b712008c1e46935f446756443a8a700f20581d138e4e6916afe5c5f9b9d6eaa0a870374b686f1a024f9bbb88c23c766654579339caf55afd149d41d").encode().hex())
        return xor._decrypt("32000a5411015504534e06024d050226")
